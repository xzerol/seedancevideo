...
- 首帧图生视频：HappyHorse `happyhorse-1.1-i2v`，需要且只能使用 1 张首帧图片。
...
- HappyHorse `happyhorse-1.1-i2v` 官方接口是首帧图生视频，`media` 中 `first_frame` 要求 exactly one，不是首尾帧接口，支持 720P/1080P、3-15 秒输出。
